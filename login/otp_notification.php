...
function showOtpNotification($user, $mail)
{
    try {
        ...
        $mail->Body = "<h2>Welcome to PBRA System, {$user['full_name']}!</h2> Enter this code to continue logging in as admin: <b>$otp</b><br>This code will expire in 5 minutes. <br>If you didn't attempt to log in, you can safely ignore this email.";
